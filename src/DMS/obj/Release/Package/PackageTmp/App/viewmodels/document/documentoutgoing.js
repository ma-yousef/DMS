    ...
    function (unitofwork, router, logger, global) {
        ...
        return (function () {
            ...
            var ctor = function () {
                ...
                //this.expireDate = ko.observable().extend({ pattern: '(^\\d*\\.?\\d*[1-9]+\\d*$)|(^[1-9]+\\d*\\.\\d*$)' });
                ...
                this.populateDocument = function () {
                   ...
                   // self.expireDate(document.ExpiryPeriod());
                ...
                this.saveDocumentErrors = ko.validatedObservable({
                ...
                this.saveDocument = function () {
                    ...
                    if (!self.isEdit()) {
                        ...
                        self.document = uow.documents.createEntity("Document", {
                            ...
                            DocumentStatusId: 1,
                           // ExpiryPeriod: self.expireDate() == null ? null : self.expireDate(),
                        ...
                        //self.document.ExpiryPeriod(self.expireDate());
                    ...
                    uow.commit().then(function () {
                        router.navigateTo("#/document/outgoingdocumentlist");
                        unblockUI("#document");
                    });
                ...
                this.readOnlyDepartmentChanged = function () {
                    ...
                    var predicate = new breeze.Predicate('DepartmentId', '==', deptId);
