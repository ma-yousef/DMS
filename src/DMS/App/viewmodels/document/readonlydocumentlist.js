        ...
        return (function () {
            ...
            var ctor = function () {
                ...
                this.searchReadOnlyDocuments = function (pageIndex) {
                    ...
                    return uow.readOnlyDocuments.find(condition, 'Issue', null, pageIndex, pageSize, 'Date desc').then(function (data) {
                ...
                this.openDocumentView = function (data) {
                    router.navigateTo("#/document/documentreview?readonlydocid=" + data.Id());
                };
